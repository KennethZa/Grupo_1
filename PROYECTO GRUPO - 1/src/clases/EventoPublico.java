...
public class EventoPublico {
    ...
    public String toString() {
        return "EventoPublico{"+ "id=" + id + "nombre=" + nombre + ", cedula=" + cedula + ", telefono=" + telefono + ", correo=" + correo + ", Direccion=" + Direccion + ", tipoEvento=" + tipoEvento + ", fechaEvento=" + fechaEvento + ", horaEvento=" + horaEvento + ", paquete=" + paquete + ", tipoPago=" + tipoPago + '}';
    }
}
