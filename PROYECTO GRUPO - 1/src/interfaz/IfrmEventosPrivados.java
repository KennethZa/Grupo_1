 ...
 * @author miche
 */
public class IfrmEventosPrivados extends javax.swing.JInternalFrame {

    EventoPrivadoBD evpbd = new EventoPrivadoBD();

    public IfrmEventosPrivados() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setResizable(true);
        setTitle("Eventos Privados");
        setPreferredSize(new java.awt.Dimension(883, 527));

        jPanel1.setBackground(new java.awt.Color(255, 204, 255));
        jPanel1.setName("Eventos Privados"); // NOI18N
        ...
        lblDecoracion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/privado.jpeg"))); // NOI18N
        lblDecoracion.setText("jLabel15");
        jPanel1.add(lblDecoracion, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 50, 460, 340));
        ...
        btn15000.setBackground(new java.awt.Color(153, 255, 204));
        btn15000.setFont(new java.awt.Font("Lucida Fax", 0, 13)); // NOI18N
        ...
        jPanel1.add(btn15000, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 460, -1, -1));
        ...
        cboxTipoEvento.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "°°°°°°°°", "MATRIMONIO", "QUINCEAÑERA", "MATINE", "BABY SHOWER", "CUMPLEAÑOS", "DESPEDIDA DE SOLTEROS" }));
        ...
        cboxPaquete.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "°°°°°°°°", "$ 5.000", "$ 10.000", "$ 15.000" }));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        IfrmRegistroPrivados e = new IfrmRegistroPrivados();
        ...
        EventoPrivado priv = new EventoPrivado();
        priv.setNombre(txtNombre.getText());
        priv.setCedula(txtCedula.getText());
        priv.setTelefono(txtTelefono.getText());
        priv.setCorreo(txtCorreo.getText());
        priv.setDireccion(txtDireccion.getText());
        priv.setTipoEvento(cboxTipoEvento.getSelectedItem().toString());
        priv.setFechaEvento(txtFecha.getText());
        priv.setHoraEvento(txtHora.getText());
        priv.setPaquete(cboxPaquete.getSelectedItem().toString());
        priv.setTipoPago(botones);
    ...
    private void btn10000ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn10000ActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "                        °°°PAQUETE DE $ 10.000°°°\n"
                + "                  SE OFRECE PARA 150 INVITADOS:\n"
                + "-> Banquete a 2 tiempos.\n"
                + "-> Decoración del jardín.\n"
                + "-> 200 Copas y bajo platos.\n"
                + "-> Fotografia y Video profesional.\n"
                + "-> Iluminaria y musica personalizada.\n"
                + "-> 100 De personal de meseros y cantinero.\n"
    ...
    private void btn15000ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn15000ActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "                        °°°PAQUETE DE $ 15.000°°°\n"
                ...
                + "-> Banquete a 2 tiempos.\n"
                + "-> Decoración del jardín.\n"
                + "-> 350 Copas y bajo platos.\n"
                + "-> Fotografia y Video profesional.\n"
                + "-> Iluminaria y musica perzonalizada.\n"
                + "-> 150 De personal de meseros y cantinero.\n"
                + "-> 120 Arreglos florales (diferentes diseños).\n"
                + "-> 3 Barra libre (hielo, sodas y licor nacional).\n"
